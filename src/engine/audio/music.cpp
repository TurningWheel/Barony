...
bool loadMusic()
{
    ...
    swampmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(swampmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    labyrinthmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(labyrinthmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    ruinsmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(ruinsmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    underworldmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(underworldmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    hellmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(hellmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    minotaurmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(minotaurmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    cavesmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(cavesmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    citadelmusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(citadelmusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    intromusic = (OPENAL_BUFFER**)malloc(sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
    memset(intromusic, 0, sizeof(OPENAL_BUFFER*) * NUMMINESMUSIC);
