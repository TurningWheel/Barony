	...
	if ( multiplayer != CLIENT && !MONSTER_INIT )
	{
		if ( myStats != nullptr )
		{
					...
					&& strcmp(myStats->name, "scriptNPC") && myStats->MISC_FLAGS[STAT_FLAG_NPC] == 0 )
				{
					...
					switch ( local_rng.getU32() % 10 )
					{
						case 0:
							...
							myStats->PER = -2;
							myStats->CHR = 4;
							myStats->helmet = newItem(HAT_HOOD_RED, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							myStats->cloak = newItem(CLOAK, EXCELLENT, 1, 1, 2, false, nullptr);
							myStats->weapon = newItem(QUARTERSTAFF, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							break;
						case 1:
						{
							// king arthur
							...
							myStats->weapon = newItem(ARTIFACT_SWORD, static_cast<Status>(status), 1, 1, local_rng.getU32(), true, nullptr);
						...
						case 4:
							...
							myStats->PER = 3;
							myStats->CHR = 20;
							myStats->helmet = newItem(LEATHER_HELM, EXCELLENT, 2, 1, local_rng.getU32(), false, nullptr);
							myStats->shield = newItem(WOODEN_SHIELD, EXCELLENT, 2, 1, local_rng.getU32(), false, nullptr);
							myStats->weapon = newItem(STEEL_AXE, EXCELLENT, 2, 1, local_rng.getU32(), false, nullptr);
							break;
						case 5:
							// othello
							...
							myStats->PER = 0;
							myStats->CHR = 30;
							myStats->gloves = newItem(BRACERS, EXCELLENT, -1, 1, local_rng.getU32(), false, nullptr);
							myStats->breastplate = newItem(IRON_BREASTPIECE, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							myStats->weapon = newItem(STEEL_SWORD, EXCELLENT, 2, 1, local_rng.getU32(), false, nullptr);
						...
						case 6:
						{
							...
							myStats->PER = 20;
							myStats->CHR = 10;
							myStats->helmet = newItem(HAT_JESTER, EXCELLENT, 5, 1, local_rng.getU32(), false, nullptr);
							int status = DECREPIT + (currentlevel > 5) + (currentlevel > 15) + (currentlevel > 20);
							myStats->weapon = newItem(ARTIFACT_MACE, static_cast<Status>(status), 1, 1, local_rng.getU32(), false, nullptr);
							int c;
							for ( c = 0; c < 2; c++ )
							{
						...
						case 8:
						{
							...
							myStats->CHR = 10;
							myStats->cloak = newItem(CLOAK, EXCELLENT, 0, 1, 2, false, nullptr);
							myStats->breastplate = newItem(IRON_BREASTPIECE, EXCELLENT, 0, 1, local_rng.getU32(), false, nullptr);
							myStats->shoes = newItem(IRON_BOOTS, EXCELLENT, 0, 1, local_rng.getU32(), false, nullptr);
							int status = DECREPIT + (currentlevel > 5) + (currentlevel > 15) + (currentlevel > 20);
							myStats->weapon = newItem(ARTIFACT_SPEAR, static_cast<Status>(status), 1, 1, local_rng.getU32(), false, nullptr);
							myStats->shield = newItem(BRONZE_SHIELD, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							break;
						}
						case 9:
							// kali
							...
							myStats->shoes = newItem(LEATHER_BOOTS_SPEED, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							myStats->weapon = newItem(SPELLBOOK_FIREBALL, EXCELLENT, 1, 1, local_rng.getU32(), false, nullptr);
							break;
						default:
							break;
					}
			...
			else
			{
				...
				myStats->appearance = 1;
				myStats->sex = static_cast<sex_t>(local_rng.getU32() % 2);
				myStats->LVL = 10;
				myStats->HP = 100;
				myStats->MAXHP = myStats->HP;
				myStats->MP = 200;
			...
			// random effects
			if ( local_rng.getU32() % 10 == 0 && strcmp(myStats->name, "scriptNPC") && myStats->MISC_FLAGS[STAT_FLAG_NPC] == 0 )
			{
			...
			if ( specialMonsterVariant == 0 && isDefaultStats )
			{
				...
				{
					my->monsterStoreType = (currentlevel / 5) * 3 + (local_rng.getU32() % 4); // scale humans with depth.  3 LVL each 5 floors, + 0-3.
				}
			...
			if ( specialMonsterVariant == 0 )
			{
				...
				if ( myStats->weapon == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_WEAPON] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						case 0:
						case 1:
							myStats->weapon = newItem(SHORTBOW, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 2:
						case 3:
							myStats->weapon = newItem(BRONZE_AXE, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 4:
						case 5:
							myStats->weapon = newItem(BRONZE_SWORD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 6:
							myStats->weapon = newItem(IRON_SPEAR, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 7:
							myStats->weapon = newItem(IRON_AXE, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 8:
							myStats->weapon = newItem(IRON_SWORD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 9:
							myStats->weapon = newItem(CROSSBOW, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
				...
				if ( myStats->shield == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_SHIELD] == 1 )
				{
					...
					else
					{
						switch ( local_rng.getU32() % 10 )
						{
							...
							case 1:
							case 2:
								myStats->shield = newItem(TOOL_TORCH, SERVICABLE, 0, 1, local_rng.getU32(), false, nullptr);
								break;
							case 3:
							case 4:
								break;
							case 5:
							case 6:
								myStats->shield = newItem(WOODEN_SHIELD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
								break;
							case 7:
							case 8:
								myStats->shield = newItem(BRONZE_SHIELD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
								break;
							case 9:
								myStats->shield = newItem(IRON_SHIELD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
								break;
						}
					}
				}
				...
				if ( myStats->helmet == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_HELM] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						...
						case 2:
							break;
						case 3:
							myStats->helmet = newItem(HAT_HOOD, WORN, 0, 1, local_rng.getU32() % 4, false, nullptr);
							break;
						case 4:
							myStats->helmet = newItem(HAT_PHRYGIAN, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 5:
							myStats->helmet = newItem(HAT_WIZARD, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 6:
						case 7:
							myStats->helmet = newItem(LEATHER_HELM, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 8:
						case 9:
							myStats->helmet = newItem(IRON_HELM, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
				...
				if ( myStats->cloak == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_CLOAK] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						...
						case 7:
						case 8:
							myStats->cloak = newItem(CLOAK, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 9:
							myStats->cloak = newItem(CLOAK_MAGICREFLECTION, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
				...
				if ( myStats->breastplate == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_ARMOR] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						...
						case 6:
						case 7:
							myStats->breastplate = newItem(LEATHER_BREASTPIECE, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 8:
						case 9:
							myStats->breastplate = newItem(IRON_BREASTPIECE, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
				...
				if ( myStats->gloves == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_GLOVES] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						...
						case 6:
						case 7:
							myStats->gloves = newItem(GLOVES, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 8:
						case 9:
							myStats->gloves = newItem(GAUNTLETS, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
				...
				if ( myStats->shoes == nullptr && myStats->EDITOR_ITEMS[ITEM_SLOT_BOOTS] == 1 )
				{
					switch ( local_rng.getU32() % 10 )
					{
						...
						case 6:
						case 7:
							myStats->shoes = newItem(LEATHER_BOOTS, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
						case 8:
						case 9:
							myStats->shoes = newItem(IRON_BOOTS, WORN, 0, 1, local_rng.getU32(), false, nullptr);
							break;
					}
				}
			}
