...
void initHuman(Entity *my, stat_t *myStats) {
	...
	if( multiplayer!=CLIENT && !MONSTER_INIT ) {
		...
		myStats->HP = 30+rand()%20; myStats->MAXHP = myStats->HP;
		myStats->MP = 20+rand()%20; myStats->MAXMP = myStats->MP;
			...
			if( rand()%25==0 ) {
				switch( rand()%10 ) {
					case 0:
						...
						myStats->sex = FEMALE;
						myStats->LVL = 1;
						myStats->HP = 10; myStats->MAXHP = myStats->HP;
						myStats->MP = 10; myStats->MAXMP = myStats->MP;
						myStats->STR = 0;
						myStats->DEX = 0;
						myStats->CON = 0;
						myStats->INT = -2;
					...
					case 1:
						...
						myStats->sex = MALE;
						myStats->LVL = 10;
						myStats->HP = 100; myStats->MAXHP = myStats->HP;
						myStats->MP = 100; myStats->MAXMP = myStats->MP;
						myStats->STR = 5;
						myStats->DEX = 5;
						myStats->CON = 5;
						myStats->INT = 5;
					...
					case 2:
						...
						myStats->sex = MALE;
						myStats->LVL = 10;
						myStats->HP = 60; myStats->MAXHP = myStats->HP;
						myStats->MP = 200; myStats->MAXMP = myStats->MP;
						myStats->STR = 2;
						myStats->DEX = 2;
						myStats->CON = 3;
						myStats->INT = 11;
					...
					case 3:
						...
						myStats->sex = MALE;
						myStats->LVL = 5;
						myStats->HP = 70; myStats->MAXHP = myStats->HP;
						myStats->MP = 50; myStats->MAXMP = myStats->MP;
						myStats->STR = 3;
						myStats->DEX = 5;
						myStats->CON = 3;
						myStats->INT = 2;
					...
					case 4:
						...
						myStats->LVL = 10;
						myStats->HP = 100; myStats->MAXHP = myStats->HP;
						myStats->MP = 20; myStats->MAXMP = myStats->MP;
						myStats->STR = 10;
						myStats->DEX = 5;
						myStats->CON = 10;
						myStats->INT = 3;
					...
					case 5:
						...
						myStats->sex = MALE;
						myStats->LVL = 10;
						myStats->HP = 50; myStats->MAXHP = myStats->HP;
						myStats->MP = 20; myStats->MAXMP = myStats->MP;
						myStats->STR = 3;
						myStats->DEX = 3;
						myStats->CON = 3;
					...
					case 9:
						...
						myStats->sex = FEMALE;
						myStats->LVL = 20;
						myStats->HP = 200; myStats->MAXHP = myStats->HP;
						myStats->MP = 200; myStats->MAXMP = myStats->MP;
						myStats->STR = 5;
						myStats->DEX = 5;
						myStats->CON = 5;
