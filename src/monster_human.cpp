	...
	for (bodypart = 0, node = my->children.first; node != nullptr; node = node->next, bodypart++)
	{
		...
		switch ( bodypart )
		{
			...
			case LIMB_HUMANOID_TORSO:
				...
				entity->z += 2.5;*/
				my->setHumanoidLimbOffset(entity, HUMAN, LIMB_HUMANOID_TORSO);
				break;
			// right leg
			...
			case LIMB_HUMANOID_RIGHTARM:
			{
				...
				my->setHumanoidLimbOffset(entity, HUMAN, LIMB_HUMANOID_RIGHTARM);
			...
			case LIMB_HUMANOID_MASK:
				...
				if ( entity->sprite != 165 && entity->sprite != 1196 )
				{
					...
					else if ( EquipmentModelOffsets.modelOffsetExists(HUMAN, entity->sprite, my->sprite) )
					{
						my->setHelmetLimbOffset(entity);
						my->setHelmetLimbOffsetWithMask(helmet, entity);
					}
