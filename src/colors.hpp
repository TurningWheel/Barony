...
constexpr Uint32 uint32ColorPlayer1 = makeColorRGB(255, 64, 64);
constexpr Uint32 uint32ColorPlayer2 = makeColorRGB(64, 255, 64);
constexpr Uint32 uint32ColorPlayer3 = makeColorRGB(255, 212, 64);
constexpr Uint32 uint32ColorPlayer4 = makeColorRGB(255, 160, 255);
constexpr Uint32 uint32ColorPlayerX = makeColorRGB(191, 191, 191);

constexpr Uint32 uint32ColorPlayer1_Ally = makeColorRGB(127, 31, 31);
constexpr Uint32 uint32ColorPlayer2_Ally = makeColorRGB(31, 127, 31);
constexpr Uint32 uint32ColorPlayer3_Ally = makeColorRGB(127, 106, 32);
...
constexpr Uint32 uint32ColorPlayer1_colorblind = makeColorRGB(64, 255, 64);
constexpr Uint32 uint32ColorPlayer2_colorblind = makeColorRGB(255, 64, 64);
constexpr Uint32 uint32ColorPlayer3_colorblind = makeColorRGB(255, 160, 255);
constexpr Uint32 uint32ColorPlayer4_colorblind = makeColorRGB(0, 160, 255);
constexpr Uint32 uint32ColorPlayerX_colorblind = makeColorRGB(191, 191, 191);

constexpr Uint32 uint32ColorPlayer1_Ally_colorblind = makeColorRGB(31, 127, 31);
constexpr Uint32 uint32ColorPlayer2_Ally_colorblind = makeColorRGB(127, 31, 31);
constexpr Uint32 uint32ColorPlayer3_Ally_colorblind = makeColorRGB(127, 80, 127);
constexpr Uint32 uint32ColorPlayer4_Ally_colorblind = makeColorRGB(0, 80, 127);
